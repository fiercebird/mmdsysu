...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <table>
        ...
        <tr>
            ...
            <td><?php echo $form->label($model,'size'); ?></td>
            <td><?php echo $form->textField($model,'size',array('size'=>20,'maxlength'=>50)); ?></td>
        </tr>
        <tr>
        ...
        <tr>
            <td><?php echo $form->label($model,'isAuto'); ?></td>
            <td><?php echo $form->textField($model,'isAuto',array('size'=>10,'maxlength'=>10)); ?></td>
            <td><?php echo $form->label($model,'what'); ?></td>
            <td><?php echo $form->textField($model,'what',array('size'=>30,'maxlength'=>30)); ?></td>
        </tr>

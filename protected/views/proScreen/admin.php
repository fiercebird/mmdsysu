...
$this->menu = array(
	...
	array('label' => '检索投影幕', 'url' => '#',  'linkOptions' => array('class' => 'search-button'), ),
);
Yii::app()->clientScript->registerScriptFile(Yii::app()->request->baseUrl . "/js/getPsRepairDetail.js");
...
$('.search-form form').submit(function(){
	$('#pro-screen-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<table id="bool_display_tbl">
    <tr>
        ...
        <td>
            保修情况
            <?php echo CHtml::activeCheckBox($model, 'guarentee', array('onclick' => 'chkBox(this, 14);')) ?>
        </td>
    </tr>
</table>
...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns' => array(
        ...
        array(
            'name' => '维修次数',
            'value' => 'PsRepair::model()->getRepair($data->pid)',
            'type' => 'html'
        ),
        array(
            'class' => 'CButtonColumn',
...
<?php //echo CHtml::link('检索投影幕', '#', array('class' => 'search-button')); ?>
</div>

...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <table>
        ...
        <tr>
            <td><?php echo $form->labelEx($model,'isAuto'); ?></td>
            <td><?php echo $form->dropDownList($model,'isAuto',array('电动'=>'电动','手动'=>'手动')); ?></td>
            <td>请选择是否电动</td>
        </tr>
        <tr>
            <td><?php echo $form->labelEx($model,'what'); ?></td>
            <td><?php echo $form->dropDownList($model,'isAuto',array('白塑'=>'白塑','玻珠'=>'玻珠')); ?></td>
            <td>请选择投影幕材料</td>
        </tr>
        <tr>

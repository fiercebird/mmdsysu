...
$this->menu=array(
	...
	array('label' => '检索调音台', 'url' => '#',  'linkOptions' => array('class' => 'search-button'), ),
);
...
$('.search-form form').submit(function(){
	$('#sound-control-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
_JS_;
	...
	'columns'=>array(
		...
		'isUsing',
                ...
                array(
                    'name' => '维修次数',
                    'value' => 'SouRepair::model()->getRepair($data->sid)',
                    'type' => 'html'
                ),
		array(
			'class'=>'CButtonColumn',

...
$this->menu=array(
	...
	array('label' => '检索混音器', 'url' => '#',  'linkOptions' => array('class' => 'search-button'), ),
);
Yii::app()->clientScript->registerScriptFile(Yii::app()->request->baseUrl . "/js/getMixRepairDetail.js");
...
<table id="bool_display_tbl">
    <tr>
        <td>
            是否在用
            <?php echo CHtml::activeCheckBox($model, 'isUsing', array('onclick'=>'chkBox(this, 11);'))?>
	</td>
        <td>
            购买时间
...
$this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		'price',
                ...
                array(
                    'name' => '维修次数',
                    'value' => 'MixRepair::model()->getRepair($data->mid)',
                    'type' => 'html'
                ),
		array(
			'class'=>'CButtonColumn',
...
<?php //echo CHtml::link('检索混音器','#',array('class'=>'search-button')); ?>
</div>

...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php echo $form->errorSummary($model); ?>
        <table>
            ...
            <tr>
                <td><?php echo $form->labelEx($model,'displayer'); ?></td>
                <td><?php echo $form->textField($model,'displayer',array('size'=>20,'maxlength'=>50)); ?></td>
                <td>输入显示器类型</td>
            </tr>
            <tr>
                <td><?php echo $form->labelEx($model,'cpu'); ?></td>
            ...
            <tr>
                <td><?php echo $form->labelEx($model,'memory'); ?></td>
                <td><?php echo $form->textField($model,'memory',array('size'=>20,'maxlength'=>50)); ?></td>
                <td>输入内存大小，单位G</td>
            </tr>
            <tr>
                <td><?php echo $form->labelEx($model,'hardDisk'); ?></td>
            ...
            <tr>
                <td><?php echo $form->labelEx($model,'mac'); ?></td>
                <td><?php echo $form->textField($model,'mac',array('size'=>20,'maxlength'=>50)); ?></td>
                <td>输入物理地址</td>
            </tr>
            <tr>
                <td><?php echo $form->labelEx($model,'ip'); ?></td>

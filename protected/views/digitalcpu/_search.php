...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<table>
        ...
        <tr>
            ...
            <td><?php echo $form->textField($model,'isUsing',array('size'=>10,'maxlength'=>10)); ?></td>
            <td><?php echo $form->label($model,'road'); ?></td>
            <td><?php echo $form->textField($model,'road',array('size'=>10,'maxlength'=>10)); ?></td>
        </tr>

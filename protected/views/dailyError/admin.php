...
$('.search-form form').submit(function(){
	$('#daily-error-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
$('#updateButton').click(function(){
        // get the ids
        var ids =  $.fn.yiiGridView.getSelection('daily-error-grid');
        ...
        {   
                ...
                $.ajax({
                        url: '".Yii::app()->createUrl('/dailyError/UpdateHandler/')."',
                        data: {ids:ids, name:name},
                        success: function(data){
                                $.fn.yiiGridView.update('daily-error-grid', {
                                        data: $(this).serialize()
                                });
                },
                error: function(){
...
$this->menu = array(
	...
	array('label'=> '导出excel', 'url' => '?r=dailyError/Excel'),
);
?>

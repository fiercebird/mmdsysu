...
class MaiNoLineController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if (isset($_POST['MaiNoLine']))
        {
            $model->attributes = $_POST['MaiNoLine'];
            if ($model->save())
    ...
    {
        $dataProvider = new CActiveDataProvider('MaiNoLine');
    ...
    {
        $model = new MaiNoLine('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['MaiNoLine'])) {
            $model->attributes = $_GET['MaiNoLine'];
            $_SESSION['prevAttr'] = $_GET['MaiNoLine'];
        }
     ...
     * @return MaiNoLine the loaded model
     * @throws CHttpException
     */
    public function loadModel($id)
    {
        $model = MaiNoLine::model()->findByPk($id);
        if ($model === null)
     ...
     * @param MaiNoLine $model the model to be validated
     */
    protected function performAjaxValidation($model)
    {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'mai-no-line-form')
        {
    ...
    {
        $res = MnlRepair::model()->findAllByAttributes(array('mid' => $mid));
        $output['res'] = array();

	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','getAjaxBuilding'),
				'users'=>array('@'),
			),
        ...
        public function actionGetAjaxBuilding()
        {
            if($_POST['campus'] === '0')
                Yii::app()->end();
            $data = CHtml::listData(Building::model()->findAllByAttributes(array('cid'=>$_POST['campus'])), 'bid', 'bname');
            echo CHtml::tag('option',array('disabled' => 'disabled', 'selected' => 'selected', 'value' => '0'), "请选择教学楼",true);

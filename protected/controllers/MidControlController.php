...
class MidControlController extends Controller
{
    ...
    {
        $model = new MidControl;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['MidControl']))
        {
            $model->attributes = $_POST['MidControl'];
            if ($model->save())
    ...
    {
        $dataProvider = new CActiveDataProvider('MidControl');
    ...
    {
        $model = new MidControl('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['MidControl'])) {
            $model->attributes = $_GET['MidControl'];
            $_SESSION['prevAttr'] = $_GET['MidControl'];
        }
     ...
     * @return MidControl the loaded model
     * @throws CHttpException
     */
    public function loadModel($id)
    {
        $model = MidControl::model()->findByPk($id);
        if ($model === null)
     ...
     * @param MidControl $model the model to be validated
     */
    protected function performAjaxValidation($model)
    {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'mid-control-form')
        {
    ...
    {
        $res = MidRepair::model()->findAllByAttributes(array('mid' => $mid));
        $output['res'] = array();

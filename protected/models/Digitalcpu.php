...
/**
 * This is the model class for table "digitalcpu".
 *
 * The followings are the available columns in table 'digitalcpu':
 * @property string $sid
 ...
 */
class Digitalcpu extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Digitalcpu the static model class
	 */

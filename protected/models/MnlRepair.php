...
/**
 * This is the model class for table "mnlRepair".
 *
 * The followings are the available columns in table 'mnlRepair':
 * @property string $id
 * @property string $mid
 ...
 * @property MaiNoLine $m
 */
class MnlRepair extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return MnlRepair the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'cc' => array(self::BELONGS_TO, 'MaiNoLine', 'mid'),
		);
	}

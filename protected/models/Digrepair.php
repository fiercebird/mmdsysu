...
/**
 * This is the model class for table "digrepair".
 *
 * The followings are the available columns in table 'digrepair':
 * @property string $id
 * @property string $sid
 ...
 * @property Digitalcpu $s
 */
class Digrepair extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Digrepair the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			's' => array(self::BELONGS_TO, 'Digitalcpu', 'sid'),
		);
	}

...
/**
 * This is the model class for table "amplifier".
 *
 * The followings are the available columns in table 'amplifier':
 * @property string $aid
 ...
 * @property Amprepair[] $amprepairs
 */
class Amplifier extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Amplifier the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('deviceNum, brand, type, power, price, buyTime, supplyCompany, guarentee', 'length', 'max'=>50),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('aid, classId, deviceNum, brand, type, power, price, isUsing, buyTime, supplyCompany, guarentee', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'amprepairs' => array(self::HAS_MANY, 'Amprepair', 'aid'),
		);
	}

...
/**
 * This is the model class for table "mixRepair".
 *
 * The followings are the available columns in table 'mixRepair':
 * @property string $id
 * @property string $mid
 ...
 * @property Mixer $m
 */
class MixRepair extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return MixRepair the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'cc' => array(self::BELONGS_TO, 'Mixer', 'mid'),
		);
	}

...
/**
 * This is the model class for table "midRepair".
 *
 * The followings are the available columns in table 'midRepair':
 * @property string $id
 * @property string $mid
 ...
 * @property MidControl $m
 */
class MidRepair extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return MidRepair the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'cc' => array(self::BELONGS_TO, 'MidControl', 'mid'),
		);
	}

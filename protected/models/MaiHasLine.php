...
/**
 * This is the model class for table "maiHasLine".
 *
 * The followings are the available columns in table 'maiHasLine':
 * @property string $mid
 ...
 * @property MhlRepair[] $mhlRepairs
 */
class MaiHasLine extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return MaiHasLine the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('brand, deviceNum, type, price, supplyCompany, buyTime, guarentee', 'length', 'max'=>50),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('mid, classId, brand, deviceNum, type, price, supplyCompany, buyTime, isUsing, guarentee', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'mhlRepairs' => array(self::HAS_MANY, 'MhlRepair', 'mid'),
		);
	}
